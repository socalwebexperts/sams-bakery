...
const rows = [
  ...
  ["ajaraski-pack-2", "Ajaraski (frozen/small) pack of 2", "Adjarian khachapuri-style, small frozen, two per pack", "$8.00", "Frozen food", "/media/uploads/ajaraski-pack-2.jpg"],
  ...
  ["abali-yogurt", "Abali yogurt", "Drinkable yogurt", "$2.00", "Drinks", "/media/uploads/abali-yogurt.jpg"],
  ["abali-yogurt-half-galon", "Abali yogurt 1/2 galon", "", "$5.00", "Drinks", "/media/uploads/abali-yogurt-half-galon.jpg"],
  ["soda", "Soda", "Assorted soft drinks", "$1.75", "Drinks", "/media/uploads/soda.jpg"],
  ["lemonade", "Lemonade", "Chilled lemonade", "$1.90", "Drinks", "/media/uploads/lemonade.jpg"],
  ["water", "Water", "Bottled water", "$1.00", "Drinks", "/media/uploads/water.jpg"],
  ["sparkling-water", "Sparkling water", "Carbonated water", "$1.90", "Drinks", "/media/uploads/sparkling-water.jpg"],
];
